...
const questionsZh = [
  ...
  ['你刷到一群朋友出去玩，但没人叫你。你会？', [['心里有点酸，但先不表现出来，看看后续',{D:1,E:1,F:1,G:1}], ['找其中一个人轻松问一句“你们怎么去的？”',{S:1,C:1,L:1,O:1}], ['自己安排点别的，再开玩笑说下次带我',{S:1,E:1,L:1,O:1}], ['默认他们有自己的圈子，我会少把自己放进去',{D:1,C:1,F:1,G:1}]]],
  ['朋友答应你的事又临时掉链子。你第一步会？', [['说清楚这件事对你有影响，一起补救',{S:1,E:1,L:1,O:1}], ['先自己补救，但以后不会太依赖他这件事',{D:1,C:1,F:1,G:1}], ['问清楚卡在哪里，下次把规则说具体点',{S:1,C:1,L:1,G:1}], ['承认失望，但也给对方一点余地',{D:1,E:1,F:1,O:1}]]],
  ...
  ['你和朋友有点冲突，但谁都没真正说破。你会？', [['约一个时间聊，想把误会拆开讲清楚',{S:1,C:1,L:1,O:1}], ['先冷静一下；如果对方也不提，我可能慢慢淡掉',{D:1,E:1,F:1,G:1}], ['从“我当时的感受”开头，也听对方怎么想',{S:1,E:1,F:1,O:1}], ['抓住核心问题，少说情绪，多说边界',{D:1,C:1,L:1,G:1}]]],
  ...
  ['你最近状态很差，需要朋友帮忙。你会？', [['直接找人说需要什么，也解释为什么重要',{S:1,E:1,L:1,O:1}], ['能不麻烦别人就先自己扛，真的不行再开口',{D:1,C:1,F:1,G:1}], ['发一个低压力请求，让对方方便就回',{S:1,C:1,F:1,O:1}], ['只找最信任的一个人，把范围控制住',{D:1,E:1,L:1,G:1}]]],
  ...
  ['你很需要朋友回应，但对方最近也很忙。你会？', [['直接说“我现在有点需要被确认一下”',{S:1,E:1,L:1,O:1}], ['先忍住不说，怕自己的需求给对方压力',{D:1,C:1,F:1,G:1}], ['问清楚你们最近怎么联系比较舒服，减少猜测',{S:1,C:1,L:1,G:1}], ['承认自己有点不安，同时给对方空间',{D:1,E:1,F:1,O:1}]]],
...
const questionsEn = [
  ...
  ['A friend breaks a promise again at the last minute. Your first move is...', [['Tell them it affected you and look for a repair together',{S:1,E:1,L:1,O:1}], ['Fix your side first, but rely on them less for this next time',{D:1,C:1,F:1,G:1}], ['Ask what blocked them, then make next time more specific',{S:1,C:1,L:1,G:1}], ['Admit you are disappointed while still leaving them room',{D:1,E:1,F:1,O:1}]]],
