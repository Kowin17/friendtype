...
const questionsZh = [
  ...
  ['你最好的朋友答应你的事又临时掉链子。你第一步会？', [['说清楚这件事对你有影响，看看他怎么回应',{S:1,E:1,L:1,O:1}], ['先自己补救，但以后不会太依赖他这件事',{D:1,C:1,F:1,G:1}], ['问清楚卡在哪里，下次把规则说具体点',{S:1,C:1,L:1,G:1}], ['承认失望，但也给对方一点余地',{D:1,E:1,F:1,O:1}]]],
  ['你、最好的朋友、还有两个常一起玩的人在群聊里对一个决定各说各的。你会？', [['丢个轻松梗缓一下，再看谁真的有意见',{S:1,E:1,F:1,O:1}], ['先不急着讲话，等信息更完整再补一句',{D:1,C:1,F:1,G:1}], ['整理几个选项，让大家投票或定时间',{S:1,C:1,L:1,O:1}], ['私下问那个没说话的人是不是不舒服',{D:1,E:1,L:1,G:1}]]],
  ['一个刚认识不久的人带你去见他的朋友群，大家已经很熟了。刚进入现场时，你会？', [['顺着他们的节奏接话，先让气氛舒服起来',{S:1,E:1,F:1,O:1}], ['靠近带你来的人一点，边听边摸清这个圈子的规则',{D:1,C:1,F:1,G:1}], ['找一个共同话题切进去，但不过度表现',{S:1,C:1,L:1,G:1}], ['不强行装熟；如果不舒服，就跟带你来的人说想慢一点',{D:1,E:1,L:1,O:1}]]],
  ['你和最好的朋友有点冲突，但谁都没真正说破。你会？', [['约一个时间聊，想把误会拆开讲清楚',{S:1,C:1,L:1,O:1}], ['先冷静一下；如果对方也不提，我可能慢慢淡掉',{D:1,E:1,F:1,G:1}], ['先做个小动作示好，让气氛回暖，再看要不要谈',{S:1,E:1,F:1,O:1}], ['抓住核心问题，少说情绪，多说边界',{D:1,C:1,L:1,G:1}]]],
  ['一个刚认识、但最近聊得越来越熟的人问你很私人的事。你还没完全准备好说。你会？', [['先说一点点，看看对方能不能帮你保住不说出去',{D:1,E:1,F:1,G:1}], ['直接说“我能讲，但我需要你保密”',{S:1,C:1,L:1,O:1}], ['如果当下氛围很安全，就诚实多讲一点',{S:1,E:1,F:1,O:1}], ['先不讲，除非这件事会影响你们关系',{D:1,C:1,L:1,G:1}]]],
  ['你最近状态很差，想找最好的朋友帮忙。你会？', [['直接找人说需要什么，也解释为什么重要',{S:1,E:1,L:1,O:1}], ['能不麻烦别人就先自己扛，真的不行再开口',{D:1,C:1,F:1,G:1}], ['发一个低压力请求，让对方方便就回',{S:1,C:1,F:1,O:1}], ['先整理好最关键的部分，只讲到自己觉得安全的位置',{D:1,E:1,L:1,G:1}]]],
  ['你最好的朋友明显在硬撑，说“没事”，但你看得出来不对。你会？', [['陪他待着，发点吃的或好笑的东西让他松一点',{S:1,E:1,F:1,O:1}], ['帮他把问题拆小，找资源或下一步方案',{D:1,C:1,L:1,G:1}], ['问他想要被陪、被分析，还是先被放过',{S:1,C:1,L:1,O:1}], ['安静陪着，不逼他说，也不急着解决',{D:1,E:1,F:1,G:1}]]],
  ['你最好的朋友搬去很远的城市后，联系变少了。你会？', [['常常丢一点生活碎片过去，不要求秒回',{S:1,E:1,F:1,O:1}], ['接受中间会断联，但见面时认真补回来',{D:1,C:1,F:1,G:1}], ['固定一个轻量 check-in，比如每月电话',{S:1,C:1,L:1,G:1}], ['在重要节点发很真诚的消息，让关系不断线',{D:1,E:1,L:1,O:1}]]],
  ['一段曾经像最好的朋友一样的关系正在慢慢变形，不像以前了。接下来一个月，你更可能？', [['不急着提，先把失落自己消化一下',{D:1,E:1,F:1,G:1}], ['约一次认真见面，问清楚你们还想不想对齐',{S:1,C:1,L:1,O:1}], ['继续自然互动，但不再要求它回到以前',{S:1,E:1,F:1,O:1}], ['减少主动投入，把关系调到更符合现实的位置',{D:1,C:1,L:1,G:1}]]],
  ['一个刚认识不久、但你有点想继续靠近的人，开始用玩笑试探你的边界。你能接受到哪一步？', [['可以开玩笑，但我会直接说清哪些点别碰',{S:1,C:1,L:1,O:1}], ['先不急着定性，多观察几次他是不是有分寸',{D:1,E:1,F:1,G:1}], ['用轻松的方式提醒一下，看对方会不会马上收住',{S:1,E:1,F:1,O:1}], ['只要我开始觉得被消耗，就会明显拉开距离',{D:1,C:1,L:1,G:1}]]],
  ['和一个很久没见的小学同学几个月没聊，突然很想 reconnect。你会？', [['发个和共同回忆有关的图或梗，只说“刚看到这个想到你”',{S:1,E:1,F:1,O:1}], ['等有真正想分享的东西，再认真开场',{D:1,C:1,L:1,G:1}], ['直接约个具体时间，别让寒暄停在表面',{S:1,C:1,L:1,O:1}], ['先从点赞或回复动态开始，慢慢把门打开',{D:1,E:1,F:1,G:1}]]],
  ['你最好的朋友拿到很重要的成就，你会怎么庆祝？', [['公开狠狠夸，再私下发一大段真心话',{S:1,E:1,F:1,O:1}], ['私下祝贺，讲一个你真的替他开心的细节',{D:1,C:1,F:1,G:1}], ['组织大家一起庆祝，让这个时刻被看见',{S:1,C:1,L:1,O:1}], ['准备一个有意义的小礼物或长消息，不抢 spotlight',{D:1,E:1,L:1,G:1}]]],
  ['你很需要最好的朋友回应，但对方最近也很忙。你会？', [['直接说“我现在有点需要被确认一下”',{S:1,E:1,L:1,O:1}], ['先忍住不说，怕自己的需求给对方压力',{D:1,C:1,F:1,G:1}], ['问清楚你们最近怎么联系比较舒服，减少猜测',{S:1,C:1,L:1,G:1}], ['承认自己有点不安，同时给对方空间',{D:1,E:1,F:1,O:1}]]],
].map(([q, a]) => ({ q, a: a.map(([text, score]) => ({ text, score })) }));

const questionsEn = [
  ['The friend who matters most to you suddenly feels distant and replies way less. What do you do?', [['Assume they may not want to stay close, so you slowly pull back too',{D:1,E:1,F:1,G:1}], ['Find a low-pressure moment and ask what is going on',{S:1,C:1,L:1,O:1}], ['Send something light to make it easy for them to re-enter',{S:1,E:1,F:1,O:1}], ['Step back first and replay what has happened recently',{D:1,C:1,L:1,G:1}]]],
  ['You see your best friend went out with two other people, and nobody invited you. What feels most natural?', [['Feel it, but keep it private and wait to see if it comes up',{D:1,E:1,F:1,G:1}], ['Ask your best friend directly: “Why didn’t you invite me?”',{S:1,C:1,L:1,O:1}], ['Make your own plan, then joke that next time they should bring you',{S:1,E:1,L:1,O:1}], ['Assume they had their own plan this time and place yourself there less',{D:1,C:1,F:1,G:1}]]],
  ['Your best friend breaks a promise again at the last minute. Your first move is...', [['Tell them it affected you and see how they respond',{S:1,E:1,L:1,O:1}], ['Fix your side first, but rely on them less for this next time',{D:1,C:1,F:1,G:1}], ['Ask what blocked them, then make next time more specific',{S:1,C:1,L:1,G:1}], ['Admit you are disappointed while still leaving them room',{D:1,E:1,F:1,O:1}]]],
  ['You, your best friend, and two people you always hang with are arguing in the group chat about a plan. You...', [['Drop something light to lower the tension, then read the room',{S:1,E:1,F:1,O:1}], ['Let the chat breathe and only add something when the picture is clearer',{D:1,C:1,F:1,G:1}], ['Turn the chaos into options, a poll, or a time everyone can choose',{S:1,C:1,L:1,O:1}], ['Check privately with the quiet person who seems uncomfortable',{D:1,E:1,L:1,G:1}]]],
  ['Someone you just met brings you into their weekend hangout crew, and everyone already has history. When you first get there, you...', [['Match their rhythm and keep the atmosphere easy',{S:1,E:1,F:1,O:1}], ['Stay close to the person who brought you and observe the group’s rhythm first',{D:1,C:1,F:1,G:1}], ['Find one shared topic and join in without over-performing',{S:1,C:1,L:1,G:1}], ['Do not force closeness; if it feels off, tell the person who brought you that you need to ease in',{D:1,E:1,L:1,O:1}]]],
  ['You and your best friend have tension, but nobody has named it. You...', [['Set a time to talk because you want to actually understand it',{S:1,C:1,L:1,O:1}], ['Cool down first; if they never bring it up either, you may drift away',{D:1,E:1,F:1,G:1}], ['Make a small warm gesture first, let the tension soften, then see if it needs a talk',{S:1,E:1,F:1,O:1}], ['Cut to the core issue with fewer emotions and clearer boundaries',{D:1,C:1,L:1,G:1}]]],
  ['Someone you just met, but have been getting closer to, asks something very personal. You are not fully ready to share. You...', [['Share a small piece first and see if they can keep it private',{D:1,E:1,F:1,G:1}], ['Say what you can share and clearly ask them to keep it private',{S:1,C:1,L:1,O:1}], ['If the moment feels safe, open up more honestly than planned',{S:1,E:1,F:1,O:1}], ['Keep it private unless it directly affects the friendship',{D:1,C:1,L:1,G:1}]]],
  ['You are having a rough week and want help from your best friend. You...', [['Ask directly for what you need and explain why it matters',{S:1,E:1,L:1,O:1}], ['Try not to bother anyone and only ask if you truly cannot handle it',{D:1,C:1,F:1,G:1}], ['Send a clear, low-pressure request so they can opt in easily',{S:1,C:1,F:1,O:1}], ['Organize the most important parts first and only share as much as feels safe',{D:1,E:1,L:1,G:1}]]],
  ['Your best friend says “I’m fine,” but you can tell they are not. You...', [['Stay nearby with food, memes, or little check-ins to soften the moment',{S:1,E:1,F:1,O:1}], ['Help break the problem into smaller next steps or resources',{D:1,C:1,L:1,G:1}], ['Ask whether they want comfort, solutions, company, or space',{S:1,C:1,L:1,O:1}], ['Sit with them quietly and do not force a confession or a fix',{D:1,E:1,F:1,G:1}]]],
  ['Your best friend moves far away and contact gets patchier. You...', [['Send small life updates often, with no pressure to reply instantly',{S:1,E:1,F:1,O:1}], ['Accept gaps, but make the catch-ups count when they happen',{D:1,C:1,F:1,G:1}], ['Create a lightweight ritual, like a monthly call or recurring check-in',{S:1,C:1,L:1,G:1}], ['Send sincere messages on important days so the thread never fully drops',{D:1,E:1,L:1,O:1}]]],
  ['A friendship that once felt like your best-friend bond is changing. Over the next month, you are most likely to...', [['Not bring it up yet and process the sadness privately',{D:1,E:1,F:1,G:1}], ['Ask to meet and talk about whether you both still want to realign',{S:1,C:1,L:1,O:1}], ['Keep interacting naturally, but stop expecting it to become what it was',{S:1,E:1,F:1,O:1}], ['Reduce your active investment and match the relationship to reality',{D:1,C:1,L:1,G:1}]]],
  ['Someone you just met, but kind of want to get closer to, starts testing your boundaries through jokes. How far can that go?', [['Jokes are fine, but I will directly name what is off-limits',{S:1,C:1,L:1,O:1}], ['I will not judge it too fast and watch whether they actually have tact',{D:1,E:1,F:1,G:1}], ['I will lightly hint that they crossed a line and see if they stop',{S:1,E:1,F:1,O:1}], ['Once I start feeling drained, I will clearly create distance',{D:1,C:1,L:1,G:1}]]],
  ['You have not talked to an elementary-school classmate in years, but suddenly miss them. You...', [['Send a meme or photo tied to an old shared memory and say, “This made me think of you”',{S:1,E:1,F:1,O:1}], ['Wait until you have something real to say, then reach out intentionally',{D:1,C:1,L:1,G:1}], ['Suggest a specific time to catch up so it does not die as small talk',{S:1,C:1,L:1,O:1}], ['Start by reacting to a story or post and let the door open slowly',{D:1,E:1,F:1,G:1}]]],
  ['Your best friend hits a major win. How do you celebrate them?', [['Hype them publicly, then send a private message with all the feelings',{S:1,E:1,F:1,O:1}], ['Congratulate them privately with one detail that proves you mean it',{D:1,C:1,F:1,G:1}], ['Coordinate a group celebration so the moment feels properly seen',{S:1,C:1,L:1,O:1}], ['Prepare a meaningful note or gift without pulling attention onto yourself',{D:1,E:1,L:1,G:1}]]],
  ['You need reassurance from your best friend, but they have been busy too. You...', [['Say directly, “I think I need a little reassurance right now”',{S:1,E:1,L:1,O:1}], ['Hold it in because you worry your needs will pressure them',{D:1,C:1,F:1,G:1}], ['Ask what kind of communication rhythm would feel clear for both of you',{S:1,C:1,L:1,G:1}], ['Admit you feel a bit off while still giving them space',{D:1,E:1,F:1,O:1}]]],
].map(([q, a]) => ({ q, a: a.map(([text, score]) => ({ text, score })) }));

const resultsZh = {
  SELG: ['气氛掌控者','当最好的朋友和固定几个人的群聊卡住时，你很会读气氛，也愿意主动把关系重新推起来。',['社交发动机','情绪敏锐','主导感强','慢慢信任']],
  SELO: ['快乐小太阳','不管是刚认识的人，还是最好的朋友身边的新圈子，你都容易让对方觉得轻松、被欢迎。',['热情','好接近','分享欲强','容易心软']],
  SEFG: ['高敏感陪伴者','对最在意的朋友，你很容易感受到细微变化，但也会怕自己的需求给别人压力。',['共情强','怕打扰','容易想多','温柔']],
  SEFO: ['无敌好朋友','你能让最好的朋友感到安全，面对刚认识的人也不太让人尴尬，是很舒服的靠近方式。',['好相处','真诚','情绪开放','随和']],
  SCLG: ['靠谱组织者','刚认识的人一起做决定时你能把事推进，最好的朋友需要你时你也会想办法让事情落地。',['执行力强','会安排','现实稳定','有边界']],
  SCLO: ['社交军师','你能进入刚认识的人的新圈子，也能看懂最好的朋友和其他人之间的暗流。',['会说话','会分析','主动','清醒']],
  SCFG: ['清醒陪玩人','你可以参与热闹，但对刚认识的人和最好的朋友的投入分得很清楚。',['外热内稳','不越界','懂场合','松弛']],
  SCFO: ['佛系开心果','你适合轻松自然的关系：刚认识的人不尴尬，最好的朋友也不用互相绑架。',['松弛','有趣','不计较','接纳度高']],
  DELG: ['深夜倾听者','你不会轻易把所有人放进来，但心里最重要的那个人难过时，你会很认真地接住。',['共情','慢热','重感情','防备心']],
  DELO: ['回忆收藏家','对曾经像最好的朋友一样的人和重要节点，你记得很深，也愿意用真诚把关系接回来。',['重感情','细腻','真诚','慢热']],
  DEFG: ['独行观察者','你需要时间判断谁值得靠近；一旦感觉不对，你会保护自己、降低投入。',['安静','观察力强','边界清楚','慢慢靠近']],
  DEFO: ['温柔边界者','你对最好的朋友温柔，但对刚认识的人会保留空间，不会为了亲近而勉强自己。',['边界感','温和','自由','慢熟']],
  DCLG: ['冷静指挥官','你在最亲近的关系里不一定话多，但遇到承诺、冲突或决定时，会很清楚地处理核心问题。',['理性','可靠','主见强','距离感']],
  DCLO: ['成熟分析师','你能区分刚认识的人、很久没见的小学同学和最好的朋友的分量，不轻易失控，也不随便投入。',['清醒','成熟','有判断力','真诚']],
  DCFG: ['高冷边界者','你刚开始会显得有距离感，但那是你在确认关系是否安全、是否值得投入。',['慢热','边界','冷静','不讨好']],
  DCFO: ['佛系自由人','你不喜欢被任何层级的友情绑架；关系舒服就靠近，不舒服就自然退开。',['自由','舒服','不强求','清醒']],
};

const resultsEn = {
  SELG: ['Vibe Commander','When your best friend and the people you always hang with get stuck, you read the room quickly and move the dynamic forward.',['Social engine','Emotionally sharp','Takes the lead','Trusts slowly']],
  SELO: ['Happy Little Sun','With someone you just met, or your best friend’s new circle, you make things feel warmer and easier almost immediately.',['Warm','Approachable','Loves sharing','Soft-hearted']],
  SEFG: ['Highly Sensitive Companion','With the friend who matters most, you notice small emotional shifts fast, but you may worry that your own needs are too much.',['Deep empathy','Afraid to bother','Overthinks','Gentle']],
  SEFO: ['Ultimate Good Friend','You make your best friend feel safe, and someone you just met usually feels comfortable around you too.',['Easygoing','Sincere','Emotionally open','Flexible']],
  SCLG: ['Reliable Organizer','With people you just met, you can move plans forward; when your best friend needs you, you try to make help practical.',['Gets things done','Plans well','Grounded','Has boundaries']],
  SCLO: ['Social Strategist','You can enter a new circle through someone you just met while still reading hidden dynamics around your best friend.',['Good with words','Analytical','Proactive','Clear-headed']],
  SCFG: ['Clear-Headed Playmate','You can join the fun, but you are clear about how much energy brand-new people versus your best friend get.',['Warm outside, steady inside','Respects limits','Reads the moment','Relaxed']],
  SCFO: ['Chill Joy-Bringer','You do best in friendships that feel natural: people you just met stay easy, and your best friend stays unforced.',['Relaxed','Fun','Not petty','Accepting']],
  DELG: ['Late-Night Listener','You do not let everyone in quickly, but when the person who matters most is hurting, you show up with serious care.',['Empathetic','Slow to warm','Deeply attached','Guarded']],
  DELO: ['Memory Keeper','You remember people who once felt like best friends and the moments that made them matter.',['Sentimental','Delicate','Sincere','Slow to warm']],
  ...
  DEFO: ['Gentle Boundary-Keeper','You are soft with your best friend, but with someone you just met, you keep enough space to stay comfortable.',['Boundaried','Kind','Free','Slow to open']],
  DCLG: ['Calm Commander','You may not be loud with your best friend, but around promises, conflict, or decisions, you handle the core issue clearly.',['Rational','Reliable','Strong-minded','Keeps distance']],
  DCLO: ['Mature Analyst','You can tell the difference between someone you just met, an old elementary-school classmate, and your best friend, and you invest accordingly.',['Clear','Mature','Good judgment','Sincere']],
