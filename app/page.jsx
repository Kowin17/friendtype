...
const resultsZh = {
  ...
  SEFO: ['无敌好朋友','你能让最亲近的人感到安全，在新关系里也不太让人尴尬，是很舒服的靠近方式。',['好相处','真诚','情绪开放','随和']],
  SCLG: ['靠谱组织者','普通朋友局里你能把事推进，最好的朋友需要你时你也会想办法让事情落地。',['执行力强','会安排','现实稳定','有边界']],
  SCLO: ['社交军师','你能进入新圈子，也能看懂熟人局里的暗流，热络之外还有判断力。',['会说话','会分析','主动','清醒']],
  SCFG: ['清醒陪玩人','你可以参与热闹，但对普通朋友和最好的朋友的投入分得很清楚。',['外热内稳','不越界','懂场合','松弛']],
  SCFO: ['佛系开心果','你适合轻松自然的关系：普通朋友不尴尬，最好的朋友也不用互相绑架。',['松弛','有趣','不计较','接纳度高']],
  ...
  DEFO: ['温柔边界者','你对最亲近的朋友温柔，但对刚认识的人会保留空间，不会为了亲近而勉强自己。',['边界感','温和','自由','慢熟']],
  DCLG: ['冷静指挥官','你在最亲近的关系里不一定话多，但遇到承诺、冲突或决定时，会很清楚地处理核心问题。',['理性','可靠','主见强','距离感']],
  DCLO: ['成熟分析师','你能区分普通朋友、熟朋友和最好的朋友的分量，不轻易失控，也不随便投入。',['清醒','成熟','有判断力','真诚']],
...
const resultsEn = {
  ...
  SEFO: ['Ultimate Good Friend','You make your closest people feel safe, and newer people usually feel comfortable around you too.',['Easygoing','Sincere','Emotionally open','Flexible']],
  SCLG: ['Reliable Organizer','In casual plans you move things forward, and when your best friend needs you, you try to make help practical.',['Gets things done','Plans well','Grounded','Has boundaries']],
  ...
  SCFG: ['Clear-Headed Playmate','You can join the fun, but you are clear about how much energy casual friends versus your closest people get.',['Warm outside, steady inside','Respects limits','Reads the moment','Relaxed']],
  SCFO: ['Chill Joy-Bringer','You do best in friendships that feel natural: casual friends stay easy, and your closest people stay unforced.',['Relaxed','Fun','Not petty','Accepting']],
  ...
  DEFO: ['Gentle Boundary-Keeper','You are soft with your closest people, but with newer people you keep enough space to stay comfortable.',['Boundaried','Kind','Free','Slow to open']],
  DCLG: ['Calm Commander','You may not be loud with your closest people, but around promises, conflict, or decisions, you handle the core issue clearly.',['Rational','Reliable','Strong-minded','Keeps distance']],
  DCLO: ['Mature Analyst','You can tell the difference between casual friends, familiar friends, and best-friend-level bonds, and you invest accordingly.',['Clear','Mature','Good judgment','Sincere']],
